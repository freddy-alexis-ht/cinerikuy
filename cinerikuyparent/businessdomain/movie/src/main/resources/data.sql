...
INSERT INTO movie (movie_code, name, duration, image_url, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
VALUES ('M002', 'El viaje de Lucas', '130 min', 'http://abc', 'http://def', 'Resumen de la película', 't', 'Director 1', 'Actor 1, Actor 2', '2:30,5:30', 'C01,C03', 't', 2, 2, 2, 2);
INSERT INTO movie (movie_code, name, duration, image_url, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
VALUES ('M003', 'Domingo en Marte', '140 min', 'http://abc', 'http://def', 'Resumen de la película', 'f', 'Director 1', 'Actor 1, Actor 2', '2:30,5:30', 'C02,C03', 't', 3, 3, 2, 2);
INSERT INTO movie (movie_code, name, duration, image_url, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
