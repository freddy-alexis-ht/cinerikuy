...
INSERT INTO movie (movie_code, name, duration, image_url, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
VALUES ('M004', 'Domingo en El Valle', '140 min', 'http://abc', 'http://def', 'Resumen de la película', 't', 'Director 1', 'Actor 1, Actor 2', '2:30,5:30', 'C02,C03', 't', 3, 3, 2, 1);
INSERT INTO movie (movie_code, name, duration, image_url, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
VALUES ('M0045', 'Domingo sin Fin', '150 min', 'http://abc', 'http://def', 'Resumen de la película', 'f', 'Director 1', 'Actor 1, Actor 2', '2:30,5:30', 'C01', 'f', 4, 1, 3, 2);
