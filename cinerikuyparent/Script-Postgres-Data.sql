...
INSERT INTO cr_movie (movie_code, name, duration, image_url, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
VALUES ('M001', 'Rapidos y Furiosos X', '2hrs 30min', 'https://cdn.apis.cineplanet.com.pe/CDN/media/entity/get/FilmPosterGraphic/HO00001614?referenceScheme=HeadOffice&allowPlaceHolder=true', 'https://youtu.be/YcguedAQu24', 'Dominic Toretto enfrenta un gran desafío que pone en peligro a sus compañeros. Toda la película se convierte en una lucha contra un villano bastante excéntrico, pero letal.', 'f', 'Louis Leterrier', 'Vin Diesel, Jason Momoa, Michelle Rodriguez, Brie Larson', '2:30,5:30,8:30', 'C01,C02,C03,C04', 't', 1, 1, 2, 2);
INSERT INTO cr_movie (movie_code, name, duration, image_url, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
VALUES ('M002', 'Spider-Man: A Través del Spider-Verso', '2hrs 20min', 'https://cdn.apis.cineplanet.com.pe/CDN/media/entity/get/FilmPosterGraphic/HO00001547?referenceScheme=HeadOffice&allowPlaceHolder=true', 'https://youtu.be/3EAUXAdXMRE', 'Después de reunirse con Gwen Stacy, el amigable vecino de tiempo completo de Brooklyn Spiderman, es lanzado a través del multiverso, donde se encuentra a un equipo de gente araña encomendada con proteger su mera existencia.', 'f', 'Joaquim Dos Santos, Justin K. Thompson, Kemp Powers', 'Hailee Steinfeld, Shameik Moore, Oscar Isaac, Daniel Kaluuya', '2:45,5:30,8:15', 'C01,C02,C04', 't', 7, 1, 2, 2);
INSERT INTO cr_movie (movie_code, name, duration, image_url, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
VALUES ('M003', 'Transformers: El Despertar de las Bestias', '2hrs 10min', 'https://cdn.apis.cineplanet.com.pe/CDN/media/entity/get/FilmPosterGraphic/HO00001615?referenceScheme=HeadOffice&allowPlaceHolder=true', 'https://youtu.be/BAyi12bzDTM', 'La batalla en la Tierra ya no es solo entre Autobots y Decepticons... Maximals, Predacons y Terrorcons se unen a Transformers: Rise of the Beasts.', 'f', 'Steven Caple Jr.', 'Ron Perlman, Michelle Yeoh, Anthony Ramos, Liza Koshy', '3:00,4:30,6:00,7:30,9:00', 'C01,C02,C03,C04', 't', 1, 1, 2, 2);
INSERT INTO cr_movie (movie_code, name, duration, image_url, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
