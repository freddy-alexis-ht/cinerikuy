...
INSERT INTO cr_city (city) VALUES ('Puno');
...
INSERT INTO cr_movie (movie_code, name, duration, image_url, image_cover, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
VALUES ('M004', 'La Sirenita', '2hrs 15min', 'https://cdn.apis.cineplanet.com.pe/CDN/media/entity/get/FilmPosterGraphic/HO00001565?referenceScheme=HeadOffice&allowPlaceHolder=true', 'https://imagenes.20minutos.es/files/image_654_369/uploads/imagenes/2023/05/30/la-sirenita-pelicula-2023.jpeg', 'https://firebasestorage.googleapis.com/v0/b/appwallpaper-75b5c.appspot.com/o/trailer%2Fsirenita.mp4?alt=media&token=096b9ab7-d991-4152-b123-b5bde5f9725d', 'Anhelando conocer el mundo más allá del mar, una joven sirena visita la superficie y se enamora del apuesto príncipe Eric. Siguiendo su corazón, hace un trato con la malvada bruja del mar, Úrsula, para experimentar la vida en tierra.', 'f', 'Rob Marshall', 'Halle Bailey, Javier Bardem, Jonah Hauer-King, Melissa McCarthy', '3:00,6:00,9:00', 'C02,C03,C04', 't', 4, 1, 2, 2);
INSERT INTO cr_movie (movie_code, name, duration, image_url, image_cover, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
...
INSERT INTO cr_movie (movie_code, name, duration, image_url, image_cover, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
VALUES ('M012', 'Kraken y Sirenas: Conoce a los Gillman (29 junio 2023)', '2hrs 0min', 'https://cdn.apis.cineplanet.com.pe/CDN/media/entity/get/FilmPosterGraphic/HO00001657?referenceScheme=HeadOffice&allowPlaceHolder=true', 'https://i0.wp.com/cinemedios.com/wp-content/uploads/2023/06/krakensysirenas_resena.jpg?fit=1200%2C675&ssl=1', 'https://www.youtube.com/watch?v=9njwwO5eXnA', 'Sumérgete en las turbulentas aguas de una escuela con una divertida y sincera comedia de acción sobre una tímida adolescente que descubre que forma parte de un legendario linaje real de míticos krakens marinos y que su destino, en las profundidades de los océanos, es más grande de lo que jamás había soñado.', 'f', 'Kirk DeMicco', 'Annie Murphy, Lana Condor, Jane Fonda, Blue Chapman', '-', '-', 't', 7, 1, 3, 2);
INSERT INTO cr_movie (movie_code, name, duration, image_url, image_cover, trailer_url, synopsis, peruvian, director, actors, schedules, cinema_codes, enabled, genre_id, language_id, situation_id, vote_id)
